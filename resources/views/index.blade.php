...
@section('styles')
    ...
    <style>
        ...
        .leaflet-popup-content-wrapper {
            ...
            /* Mengatur agar teks rata tengah */
    </style>
@endsection
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="PointModalLabel">Masukkan Informasi Situs</h1>
                ...
                <div class="modal-body">
                    <form action="{{ route('store-point') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label for="geom" class="form-label">Koordinat Lokasi</label>
...
@section('script')
    ...
    <script>
        // Map
        var map = L.map('map').setView([-7.5581411, 112.3783927], 13);
        ...
        var polyline = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                var popupContent = "Name: " + feature.properties.name + "<br>" +
                    ...
                    "<button type='submit' class='btn btn-danger' onclick='return confirm(`Yakin nih polylinenya dihapus?`)'><i class='fa-solid fa-trash-can'></i></button>" +
        ...
        var polygon = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                var popupContent ="<h5>" + feature.properties.name + "</h5>"+ "<br>" +
                    ...
                    "<button type='submit' class='btn btn-danger' onclick='return confirm(`Yakin nih polygonnya dihapus?`)'><i class='fa-solid fa-trash-can'></i></button>" +
